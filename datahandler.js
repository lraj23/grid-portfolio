...
const dataFile = "gportfolio.json";
const dataFilePath = join(import.meta.dirname, dataFile);
let GPortfolio = JSON.parse(fs.readFileSync(dataFilePath, "utf8"));
...
function getGPortfolio() {
	return cloneObj(GPortfolio);
}

function saveState(data) {
	GPortfolio = cloneObj(data);
